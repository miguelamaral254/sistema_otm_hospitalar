...
def generate_pdf(rmse, mae, mape, df):
    pdf_filename = "artifacts/resultados_modelo_tipo_estabelecimento.pdf"
    ...
    c.drawString(100, height - 100, "Resultados do Modelo de Previsão de Tipo de Estabelecimento")
